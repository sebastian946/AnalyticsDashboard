...
export const Sidebar = () => {
  ...
  return (
    <aside className="w-64 min-h-screen bg-white dark:bg-dark-surface border-r border-slate-200 dark:border-dark-border flex flex-col fixed left-0 top-0 z-50">
      {/* Brand */}
      ...
      <div className="flex flex-col gap-4 p-4">
        <div className="bg-slate-100 dark:bg-slate-800/50 p-4 rounded-xl border border-slate-200 dark:border-slate-700">
          <p className="text-xs text-slate-500 dark:text-slate-400 mb-2">Usage Plan</p>
